...
namespace Calliope.Unity.Repositories
{
    ...
    /// Expects variation sets to be placed in the Resources/Calliope/VariationSets folder
    /// </summary>
    public class ResourcesVariationSetRepository : ResourcesRepositoryBase<IVariationSet, VariationSetSO>,
        IVariationSetRepository
    {
        public ResourcesVariationSetRepository() : base("Calliope/VariationSets") { }
