...
namespace Calliope.Unity.Repositories
{
    ...
    /// </summary>
    public class AddressableSceneTemplateRepository : AddressablesRepositoryBase<ISceneTemplate, SceneTemplateSO>,
        ISceneTemplateRepository
    {
        public AddressableSceneTemplateRepository() : base("Scene") { }
